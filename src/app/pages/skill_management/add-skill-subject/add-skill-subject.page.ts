...
/* tslint:disable */ 
@Component({
  selector: 'app-add-skill-subject',
  templateUrl: './add-skill-subject.page.html',
  styleUrls: ['./add-skill-subject.page.scss'],
})

export class AddSkillSubjectPage implements OnInit, OnDestroy {
  constructor(
  ...
  //--------------  getlist data fetch start -------------
    ...
    // ------ init function call start ------
      ...
      commonFunction(){
        ...
        // getlist data
        // this.getlist('skill_qual_subject/getlist');

        if( this.parms_action_name == 'edit'){
          // form submit api edit
          this.form_api = 'skill_qual_subject/return_edit/'+this.parms_action_id;
        }else{
          // form submit api add
          this.form_api = 'skill_qual_subject/return_add'
        }
      ...
      (response:any) => {
        ...
        if(response.return_status > 0){
          ...
          if(this.clickButtonTypeCheck == 'Save'){
            ...
            this.router.navigate(['/skill_qual_subject']);
