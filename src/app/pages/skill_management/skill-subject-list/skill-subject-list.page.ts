...
/* tslint:disable */ 
@Component({
  selector: 'app-skill-subject-list',
  templateUrl: './skill-subject-list.page.html',
  styleUrls: ['./skill-subject-list.page.scss'],
})
// End here

export class SkillSubjectListPage implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    // ------ init function call start -------
      commonFunction(){
        ...
        this.headerUrlapi = 'skill_qual_subject/header';
    
        // table list data url name
        this.listing_url = 'skill_qual_subject/return_index';
