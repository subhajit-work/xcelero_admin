...
export class SkillInterestListPage implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    // ------ init function call start -------
      commonFunction(){
        ...
        this.headerUrlapi = 'skill_qual_interest/header';
    
        // table list data url name
        this.listing_url = 'skill_qual_interest/return_index';
