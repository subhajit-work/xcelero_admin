...
/* tslint:disable */ 
@Component({
  selector: 'app-add-skill-degree',
  templateUrl: './add-skill-degree.page.html',
  styleUrls: ['./add-skill-degree.page.scss'],
})

export class AddSkillDegreePage implements OnInit, OnDestroy {
  constructor(
  ...
  //--------------  getlist data fetch start -------------
    ...
    // ------ init function call start ------
      ...
      commonFunction(){
        ...
        // getlist data
        this.getlist('skill_qual_degree/getlist');

        if( this.parms_action_name == 'edit'){
          // form submit api edit
          this.form_api = 'skill_qual_degree/return_edit/'+this.parms_action_id;
        }else{
          // form submit api add
          this.form_api = 'skill_qual_degree/return_add'
        }
      ...
      (response:any) => {
        ...
        if(response.return_status > 0){
          ...
          if(this.clickButtonTypeCheck == 'Save'){
            ...
            this.router.navigate(['/skill_qual_degree']);
