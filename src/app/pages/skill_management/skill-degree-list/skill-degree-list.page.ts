...
/* tslint:disable */ 
@Component({
  selector: 'app-skill-degree-list',
  templateUrl: './skill-degree-list.page.html',
  styleUrls: ['./skill-degree-list.page.scss'],
})
// End here

export class SkillDegreeListPage implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    // ------ init function call start -------
      commonFunction(){
        ...
        this.headerUrlapi = 'skill_qual_degree/header';
    
        // table list data url name
        this.listing_url = 'skill_qual_degree/return_index';
