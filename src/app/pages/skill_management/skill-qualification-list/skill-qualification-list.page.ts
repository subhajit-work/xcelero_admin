...
/* tslint:disable */ 
@Component({
  selector: 'app-skill-qualification-list',
  templateUrl: './skill-qualification-list.page.html',
  styleUrls: ['./skill-qualification-list.page.scss'],
})
// End here


export class SkillQualificationListPage implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    // ------ init function call start -------
      commonFunction(){
        ...
        this.headerUrlapi = 'skill_qualification/header';
    
        // table list data url name
        this.listing_url = 'skill_qualification/return_index';
