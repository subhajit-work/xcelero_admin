...
@Component({
  ...
  templateUrl: './add-industry-type.page.html',
  styleUrls: ['./add-industry-type.page.scss'],
})

export class AddIndustryTypePage implements OnInit, OnDestroy {
  constructor(
    ...
    // ------ init function call start ------
      ...
      commonFunction(){
        ...
        if( this.parms_action_name == 'edit'){
          ...
          this.form_api = 'industry_type/return_edit/'+this.parms_action_id;
        }else{
          // form submit api add
          this.form_api = 'industry_type/return_add'
        }
      ...
      (response:any) => {
        ...
        if(response.return_status > 0){
          ...
          if(this.clickButtonTypeCheck == 'Save'){
            ...
            this.router.navigate(['/industry_type']);
