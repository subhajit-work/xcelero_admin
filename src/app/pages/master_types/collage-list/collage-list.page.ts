...
@Component({
  ...
  templateUrl: './collage-list.page.html',
  styleUrls: ['./collage-list.page.scss'],
})
// End here


export class CollageListPage implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    // ------ init function call start -------
      commonFunction(){
        ...
        this.headerUrlapi = 'college/header';
    
        // table list data url name
        this.listing_url = 'college/return_index';
