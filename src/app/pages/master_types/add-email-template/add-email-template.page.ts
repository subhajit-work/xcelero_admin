...
@Component({
  ...
  templateUrl: './add-email-template.page.html',
  styleUrls: ['./add-email-template.page.scss'],
})

export class AddEmailTemplatePage implements OnInit, OnDestroy {
  constructor(
...
//--------------  getlist data fetch start -------------
  ...
  // ------ init function call start ------
    ...
    commonFunction(){
      ...
      // getlist data
      // this.getlist('email/getlist');

      if( this.parms_action_name == 'edit'){
        // form submit api edit
        this.form_api = 'email/return_edit/'+this.parms_action_id;
      }else{
        // form submit api add
        this.form_api = 'email/return_add'
      }
        ...
        (res:any) => {
          ...
          if(res.return_status > 0){
            this.model = {
              ...
              from_name: res.return_data.from_name,
              from_email: res.return_data.from_email,
  ...
  reloadPage(){
    if( this.parms_action_name == 'add'){
      ...
      this.model = {
        ...
        from_name: this.allEditData.return_data.from_name,
        from_email: this.allEditData.return_data.from_email,
