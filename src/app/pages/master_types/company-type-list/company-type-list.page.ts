...
@Component({
  ...
  templateUrl: './company-type-list.page.html',
  styleUrls: ['./company-type-list.page.scss'],
})
// End here


export class CompanyTypeListPage implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    // ------ init function call start -------
      commonFunction(){
        ...
        this.headerUrlapi = 'company_type/header';
    
        // table list data url name
        this.listing_url = 'company_type/return_index';
