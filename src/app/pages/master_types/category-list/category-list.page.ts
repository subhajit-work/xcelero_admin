  ...
  constructor(
    ...
    // ------ init function call start -------
      commonFunction(){
        ...
        this.headerUrlapi = 'category/header';
        
        if(this.parms_action_id != null){
          // console.log('category child');
          this.listing_url = 'category/return_index/'+this.parms_action_id;
          this.enable_listing_url = 'category/return_index';
          this.hasChildList = true;
        }else{
          // console.log('category');
          // table list data url name
          this.listing_url = 'category/return_index';
          this.enable_listing_url = 'category/return_index';
