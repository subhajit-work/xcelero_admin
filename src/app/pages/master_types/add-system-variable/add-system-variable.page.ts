...
/* tslint:disable */ 
@Component({
  selector: 'app-add-system-variable',
  templateUrl: './add-system-variable.page.html',
  styleUrls: ['./add-system-variable.page.scss'],
})

export class AddSystemVariablePage implements OnInit, OnDestroy {
  constructor(
...
//--------------  getlist data fetch start -------------
  ...
  // ------ init function call start ------
    ...
    commonFunction(){
      ...
      // getlist data
      // this.getlist('variable/getlist');

      if( this.parms_action_name == 'edit'){
        // form submit api edit
        this.form_api = 'variable/return_edit/'+this.parms_action_id;
      }else{
        // form submit api add
        this.form_api = 'variable/return_add'
      }
  ...
  reloadPage(){
    if( this.parms_action_name == 'add'){
      ...
      this.model = {
        ...
        value: this.allEditData.return_data.value,
      };
