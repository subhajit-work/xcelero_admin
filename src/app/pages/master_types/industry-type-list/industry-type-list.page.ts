...
@Component({
  ...
  templateUrl: './industry-type-list.page.html',
  styleUrls: ['./industry-type-list.page.scss'],
})
// End here


export class IndustryTypeListPage implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    // ------ init function call start -------
      commonFunction(){
        ...
        this.headerUrlapi = 'industry_type/header';
    
        // table list data url name
        this.listing_url = 'industry_type/return_index';
