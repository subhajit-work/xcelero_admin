...
/* tslint:disable */ 
@Component({
  selector: 'app-add-adminmenu',
  templateUrl: './add-adminmenu.page.html',
  styleUrls: ['./add-adminmenu.page.scss'],
})

export class AddAdminmenuPage implements OnInit, OnDestroy {
  constructor(
  ...
  // ------ init function call start ------
    ...
    commonFunction(){
      ...
      if( this.parms_action_name == 'edit'){
        ...
        this.form_api = 'adminmenu/return_edit/'+this.parms_action_id;
      }else{
        // form submit api add
        this.form_api = 'adminmenu/return_add'
      }
        ...
        (res:any) => {
          ...
          if(res.return_status > 0){
            this.model = {
              ...
              page_name: res.return_data.page_name,
...
//----------- reload page start ------------
  reloadPage(){
    ...
    /* this.commonUtils.menuDataobservable.subscribe(res =>{
      console.log('menu data subscrib >>>>>>>>>>', res);
    ...
    if( this.parms_action_name == 'add'){
      ...
      if(this.parms_action_id){
        this.model.parent_id = this.parms_action_id;
      ...
      this.model = {
        ...
        page_name: this.allEditData.return_data.page_name,
        order_id: this.allEditData.return_data.order_id,
        icon: this.allEditData.return_data.icon,
        parent_id: this.allEditData.return_data.parent_id,
