...
@Component({
  ...
  templateUrl: './add-company-type.page.html',
  styleUrls: ['./add-company-type.page.scss'],
})

export class AddCompanyTypePage implements OnInit, OnDestroy {
  constructor(
...
//--------------  getlist data fetch start -------------
  ...
  // ------ init function call start ------
    ...
    commonFunction(){
      ...
      // getlist data
      // this.getlist('company_type/getlist');

      if( this.parms_action_name == 'edit'){
        // form submit api edit
        this.form_api = 'company_type/return_edit/'+this.parms_action_id;
      }else{
        // form submit api add
        this.form_api = 'company_type/return_add'
      }
        ...
        (res:any) => {
          ...
          if(res.return_status > 0){
            this.model = {
              ...
              preffix: res.return_data.preffix,
    ...
    (response:any) => {
      ...
      if(response.return_status > 0){
        ...
        if(this.clickButtonTypeCheck == 'Save'){
          ...
          this.router.navigate(['/company_type']);
  ...
  reloadPage(){
    if( this.parms_action_name == 'add'){
      ...
      this.model = {
        ...
        preffix: this.allEditData.return_data.preffix,
