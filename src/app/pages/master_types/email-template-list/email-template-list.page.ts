...
@Component({
  ...
  styleUrls: ['./email-template-list.page.scss'],
})
// End here


export class EmailTemplateListPage implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    // ------ init function call start -------
      commonFunction(){
        ...
        this.headerUrlapi = 'email/header';
    
        // table list data url name
        this.listing_url = 'email/return_index';
