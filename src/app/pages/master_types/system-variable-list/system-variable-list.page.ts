...
/* tslint:disable */ 
@Component({
  selector: 'app-system-variable-list',
  templateUrl: './system-variable-list.page.html',
  styleUrls: ['./system-variable-list.page.scss'],
})
// End here


export class SystemVariableListPage implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    // ------ init function call start -------
      commonFunction(){
        ...
        this.headerUrlapi = 'variable/header';
    
        // table list data url name
        this.listing_url = 'variable/return_index';
