  ...
  constructor(
    ...
    // ------ init function call start -------
      commonFunction(){
        ...
        this.headerUrlapi = 'order_details/header';
    
        // table list data url name
        this.listing_url = 'order_details/return_index';
      ...
      onDownload(_identifier, _items, _item){
        ...
        if(_identifier == 'multiple'){
          this.itemsSubscribe = this.authService.globalparamsData.subscribe(res => {
            this.export_url = this.main_url+'/order_details/download_csv?id='+items_id_array.join()+'&token='+res.token;
          });
        ...
        }else if(_identifier == 'single'){
        this.itemsSubscribe = this.authService.globalparamsData.subscribe(res => {
          this.export_url = this.main_url+'/order_details/download_invoice/'+_item.id+'?token='+res.token+'&master='+res.master;
        });
        window.open(this.export_url);
