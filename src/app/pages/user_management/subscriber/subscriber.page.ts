...
export class SubscriberPage implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    // ------ init function call start -------
      commonFunction(){
        ...
        this.headerUrlapi = 'subscriber/header';
    
        // table list data url name
        this.listing_url = 'subscriber/return_index';


        this.onHeaderData(this.headerUrlapi);
        
        // getlist data url name
        // this.getlist('subscriber/getlist');
      ...
      onDownload(_identifier, _items, _item){
        ...
        if(_identifier == 'multiple'){
          this.itemsSubscribe = this.authService.globalparamsData.subscribe(res => {
            this.export_url = this.main_url+'/subscriber/download_csv?id='+items_id_array.join()+'&token='+res.token;
          });
