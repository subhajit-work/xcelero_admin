      ...
      onDownload(_identifier, _items, _item){
        ...
        if(_identifier == 'multiple'){
          ...
          this.getListSubscribe = this.authService.globalparamsData.subscribe(res => {
            ...
            console.log('res', res);
            this.download = _items[_item].resume;
            console.log('this.download', _items[_item].resume);
          //  this.export_url = this.main_url+'/transaction_print/'+_item+'?token='+res.token+'&master='+res.master;
            this.export_url = this.file_url+'/'+this.download;
            console.log('this.export_url', this.export_url);
          });
          window.open(this.export_url);
        }
