...
export class AddTestimonialPage implements OnInit, OnDestroy {
  constructor(
...
//--------------  getlist data fetch start -------------
  ...
  // ------ init function call start ------
    ...
    commonFunction(){
      ...
      // getlist data
      // this.getlist('testimonial/getlist');

      if( this.parms_action_name == 'edit'){
        // form submit api edit
        this.form_api = 'testimonial/return_edit/'+this.parms_action_id;
      }else{
        // form submit api add
        this.form_api = 'testimonial/return_add'
      }
      ...
      this.editDataSubscribe = this.http.get(this.form_api).subscribe(
        (res:any) => {
          ...
          if(res.return_status > 0){
            ...
            if(res.return_data.image){
              this.model.image = res.return_data.image;
            }
...
//----------- reload page start ------------
  reloadPage(){
    if( this.parms_action_name == 'add'){
      ...
      if(this.allEditData.return_data.image){
        this.model.image = this.allEditData.return_data.image;
      }
    }
  }
  // reload alert
