...
export class AddFaqPage implements OnInit, OnDestroy {
  constructor(
...
//--------------  getlist data fetch start -------------
  ...
  // ------ init function call start ------
    ...
    commonFunction(){
      ...
      // getlist data
      // this.getlist('faq/getlist');

      if( this.parms_action_name == 'edit'){
        // form submit api edit
        this.form_api = 'faq/return_edit/'+this.parms_action_id;
      }else{
        // form submit api add
        this.form_api = 'faq/return_add'
      }
