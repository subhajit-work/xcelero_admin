  ...
  constructor(
    ...
    // ------ init function call start -------
      commonFunction(){
        ...
        this.headerUrlapi = 'menu/header';
        
        if(this.parms_action_id != null){
          // console.log('menu child');
          this.listing_url = 'menu/return_index/'+this.parms_action_id;
          this.enable_listing_url = 'menu/return_index';
          this.hasChildList = true;
        }else{
          // console.log('menu');
          // table list data url name
          this.listing_url = 'menu/return_index';
          this.enable_listing_url = 'menu/return_index';
