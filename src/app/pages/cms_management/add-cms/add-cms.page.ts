...
@Component({
  ...
  templateUrl: './add-cms.page.html',
  styleUrls: ['./add-cms.page.scss'],
})

export class AddCmsPage implements OnInit, OnDestroy {
  constructor(
...
//--------------  getlist data fetch start -------------
  ...
  // ------ init function call start ------
    ...
    commonFunction(){
      ...
      // getlist data
      // this.getlist('cms/getlist');

      if( this.parms_action_name == 'edit'){
        // form submit api edit
        this.form_api = 'cms/return_edit/'+this.parms_action_id;
      }else{
        // form submit api add
        this.form_api = 'cms/return_add'
      }
