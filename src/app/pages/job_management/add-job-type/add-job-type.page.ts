...
@Component({
  ...
  templateUrl: './add-job-type.page.html',
  styleUrls: ['./add-job-type.page.scss'],
})

export class AddJobTypePage implements OnInit, OnDestroy {
  constructor(
...
//--------------  getlist data fetch start -------------
  ...
  // ------ init function call start ------
    ...
    commonFunction(){
      ...
      // getlist data
      // this.getlist('job_type/getlist');

      if( this.parms_action_name == 'edit'){
        // form submit api edit
        this.form_api = 'job_type/return_edit/'+this.parms_action_id;
      }else{
        // form submit api add
        this.form_api = 'job_type/return_add'
      }
