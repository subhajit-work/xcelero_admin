...
@Component({
  ...
  templateUrl: './job-type-list.page.html',
  styleUrls: ['./job-type-list.page.scss'],
})
// End here


export class JobTypeListPage implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    // ------ init function call start -------
      commonFunction(){
        ...
        this.headerUrlapi = 'job_type/header';
    
        // table list data url name
        this.listing_url = 'job_type/return_index';
