...
/* tslint:disable */ 
@Component({
  selector: 'app-add-question-subject',
  templateUrl: './add-question-subject.page.html',
  styleUrls: ['./add-question-subject.page.scss'],
})

export class AddQuestionSubjectPage implements OnInit, OnDestroy {
  constructor(
  ...
  // ------ init function call start ------
    ...
    commonFunction(){
      ...
      if( this.parms_action_name == 'edit'){
        ...
        this.form_api = 'question_subject/return_edit/'+this.parms_action_id;
      }else{
        // form submit api add
        this.form_api = 'question_subject/return_add'
      }
    ...
    (response:any) => {
      ...
      if(response.return_status > 0){
        ...
        if(this.clickButtonTypeCheck == 'Save'){
          ...
          this.router.navigate(['/question_subject']);
