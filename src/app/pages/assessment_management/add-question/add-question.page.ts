  ...
  // ------ init function call start ------
    ...
    commonFunction(){
      ...
      if( this.parms_action_name == 'edit'){
        ...
        this.form_api = 'question/return_edit/'+this.parms_action_id;
      }else{
        // form submit api add
        this.form_api = 'question/return_add'
      }
        ...
        (res:any) => {
          ...
          if(res.return_status > 0){
            this.model = {
              ...
              correct_option: res.return_data.correct_option,
              subject_id: res.return_data.subject_id,
            ...
            if(res.return_data.description){
              this.model.description = res.return_data.description;
            }

            // multiple question option
            if(res.return_data.option.length > 0){
              this.model.pages = res.return_data.option;
            }else{
              this.model.pages = [
                {
                  "is_default":true
    ...
    this.plt.ready().then(() => {
      ...
      this.getListSubscribe = this.commonUtils.getlistCommon(_getlistUrl).subscribe(
        resData => {
          ...
          this.subjectList = resData.subject;
        },
        errRes => {
          this.selectLoading = false;
        }
  ...
  reloadPage(){
    if( this.parms_action_name == 'add'){
      ...
      this.model = {
        ...
        correct_option: this.allEditData.return_data.correct_option,
        subject_id: this.allEditData.return_data.subject_id,
      ...
      if(this.allEditData.return_data.description){
        this.model.description = this.allEditData.return_data.description;
      }


      // multiple question option
      if(this.allEditData.return_data.option.length > 0){
        this.model.pages = this.allEditData.return_data.option;
      }else{
        this.model.pages = [
          {
            "is_default":true
