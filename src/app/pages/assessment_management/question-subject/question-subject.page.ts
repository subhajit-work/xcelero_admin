...
/* tslint:disable */ 
@Component({
  selector: 'app-question-subject',
  templateUrl: './question-subject.page.html',
  styleUrls: ['./question-subject.page.scss'],
})
// End here


export class QuestionSubjectPage implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    // ------ init function call start -------
      commonFunction(){
        ...
        this.headerUrlapi = 'question_subject/header';
