...
@Component({
  ...
  templateUrl: './add-company-category.page.html',
  styleUrls: ['./add-company-category.page.scss'],
})

export class AddCompanyCategoryPage implements OnInit, OnDestroy {
  constructor(
...
//--------------  getlist data fetch start -------------
  ...
  // ------ init function call start ------
    ...
    commonFunction(){
      ...
      // getlist data
      // this.getlist('company_category/getlist');

      if( this.parms_action_name == 'edit'){
        // form submit api edit
        this.form_api = 'company_category/return_edit/'+this.parms_action_id;
      }else{
        // form submit api add
        this.form_api = 'company_category/return_add'
      }
    ...
    (response:any) => {
      ...
      if(response.return_status > 0){
        ...
        if(this.clickButtonTypeCheck == 'Save'){
          ...
          this.router.navigate(['/company_category']);
