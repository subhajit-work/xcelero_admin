...
/* tslint:disable */ 
@Component({
  selector: 'app-company-category-list',
  templateUrl: './company-category-list.page.html',
  styleUrls: ['./company-category-list.page.scss'],
})
// End here


export class CompanyCategoryListPage implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    // ------ init function call start -------
      commonFunction(){
        ...
        this.headerUrlapi = 'company_category/header';
    
        // table list data url name
        this.listing_url = 'company_category/return_index';
