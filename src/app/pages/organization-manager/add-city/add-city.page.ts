...
export class AddCityPage implements OnInit, OnDestroy {
  constructor(
...
//--------------  getlist data fetch start -------------
  ...
  // ------ init function call start ------
    ...
    commonFunction(){
      ...
      // getlist data
      this.getlist('city/getlist');

      if( this.parms_action_name == 'edit'){
        // form submit api edit
        this.form_api = 'city/return_edit/'+this.parms_action_id;
      }else{
        // form submit api add
        this.form_api = 'city/return_add'
      }
